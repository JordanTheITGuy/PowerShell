...
.EXAMPLE
	import-module TSxLogging

.NOTES
    FileName:    TSxLogging.psd1
...
@{
	...
	ModuleToProcess = 'TSxLogging.psm1'
	
	# Version number of this module.
	ModuleVersion = '0.0.0.1'
	
	# ID used to uniquely identify this module
	GUID = 'e2444b03-6662-44b5-b0c3-d80121d84d01'
	...
	Description = 'Powershell Module for TrueSec Infrastructure Logging'
	...
	FunctionsToExport = 'Write-TsxLog' #For performanace, list functions explicity
	
	# Cmdlets to export from this module
	CmdletsToExport = 'Write-TsxLog'
